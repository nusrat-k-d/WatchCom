...
export function ActorHero({ actor }: ActorHeroProps) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-sans font-light text-gray-400">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div>{formatDate(actor.birthday)}</div>
                </div>
              </div>
              ...
              {actor.place_of_birth && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="truncate max-w-[200px]" title={actor.place_of_birth}>
                      {actor.place_of_birth}
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="font-semibold text-white">{actor.popularity.toFixed(1)}</span>
                    <span className="text-[10px] text-gray-600">points</span>
                  </div>
                </div>
              </div>

              {/* Passed Away (if applicable) */}
              {actor.deathday && (
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white/5 rounded-lg border border-white/5">
                  ...
                  <div>
                    ...
                    <div>{formatDate(actor.deathday)}</div>
                  </div>
                </div>
              )}
            </div>
