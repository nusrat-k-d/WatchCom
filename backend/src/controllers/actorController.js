...
/**
 * Controller for getting actor details by person ID
 * Route: GET /api/actors/:id
 */
export const getActorDetails = asyncHandler(async (req, res) => {
  const { id } = req.params;
...
/**
 * Controller for getting movies an actor has worked in
